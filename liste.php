  ...
  <main class="pt-5 pb-4">
    <div class="container">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form class="sign-up-form" method="post" action="aref.php" name="consultation">
              ...
              <select class="form-select text-center" aria-label="Default select example" id="selectElementId" name="abac" required>
                <option value="0" selected="">Année d’obtention du Bac ⛥ سنة الحصول على الباك </option>
              </select>
        
              <select class="form-select text-center" aria-label="Default select example" name="type" id="type" required>
                <optgroup label="">
                  <option value="0" selected=""> Cycle ⛥ السلك </option>
                  <option value="1">1er Cycle ⛥   السلك الأول</option>
                  <option value="2">Master ⛥   سلك الماستر</option>
                  <option value="3">Doctorat ⛥ سلك الدكتوراه</option>
                </optgroup>
              </select>
